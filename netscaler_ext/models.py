...
class NetscalerExtExampleModel(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for Netscaler Ext app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "Netscaler Exts"
