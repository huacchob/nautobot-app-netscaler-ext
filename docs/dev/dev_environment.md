...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 2.4.7)
- `project_name`: the default docker compose project name (default: `netscaler-ext`)
...
#14 naming to docker.io/netscaler-ext/nautobot:2.4.7-py3.11 done
```
...
Creating network "netscaler_ext_default" with the default driver
Creating volume "netscaler_ext_postgres_data" with default driver
Creating netscaler_ext_redis_1 ...
Creating netscaler_ext_docs_1  ...
Creating netscaler_ext_postgres_1 ...
Creating netscaler_ext_postgres_1 ... done
Creating netscaler_ext_redis_1    ... done
Creating netscaler_ext_nautobot_1 ...
Creating netscaler_ext_docs_1     ... done
Creating netscaler_ext_nautobot_1 ... done
Creating netscaler_ext_worker_1   ...
Creating netscaler_ext_worker_1   ... done
...
Stopping netscaler_ext_worker_1   ...
Stopping netscaler_ext_nautobot_1 ...
Stopping netscaler_ext_docs_1     ...
Stopping netscaler_ext_redis_1    ...
Stopping netscaler_ext_postgres_1 ...
Stopping netscaler_ext_worker_1   ... done
Stopping netscaler_ext_nautobot_1 ... done
Stopping netscaler_ext_postgres_1 ... done
Stopping netscaler_ext_redis_1    ... done
Stopping netscaler_ext_docs_1     ... done
Removing netscaler_ext_worker_1   ...
Removing netscaler_ext_nautobot_1 ...
Removing netscaler_ext_docs_1     ...
Removing netscaler_ext_redis_1    ...
Removing netscaler_ext_postgres_1 ...
Removing netscaler_ext_postgres_1 ... done
Removing netscaler_ext_docs_1     ... done
Removing netscaler_ext_worker_1   ... done
Removing netscaler_ext_redis_1    ... done
Removing netscaler_ext_nautobot_1 ... done
Removing network netscaler_ext_default
```
...
```python
namespace = Collection("netscaler_ext")
namespace.configure(
    {
        "netscaler_ext": {
            ...
...
Or set the `INVOKE_NETSCALER_EXT_PYTHON_VER` variable.
...
Or set the `INVOKE_NETSCALER_EXT_NAUTOBOT_VER` variable.
...
In the package source, there is the `netscaler_ext/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
