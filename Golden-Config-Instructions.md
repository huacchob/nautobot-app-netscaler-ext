...
You can find the dispatcher tests in `custom_dispatchers/tests/test_<platform_name>.py`
...
- [Cisco IOS](golden_config_docs/cisco_ios.md)
...
- [Cisco XE](golden_config_docs/cisco_xe.md)
- [Citrix Netscaler](golden_config_docs/citrix_netscaler.md)
- [WTI](golden_config_docs/wti.md)

Nautobot Setup:

- [Nautobot Setup for Golden Config Dispatchers](golden_config_docs/nautobot_setup.md)

Custom Remediation:

- [Custom Remediation for Nautobot Golden Config](golden_config_docs/custom_remediation.md)
